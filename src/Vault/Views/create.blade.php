...
@section ('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{route('access.users.create')}}" class="bread-current">Create User</a></li>
    </ol>
@stop
...
@section('content')
    ...
    <div class="widget">
        ...
        <div class="widget-content">
            ...
            {!! Form::open(['route' => 'access.users.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}
